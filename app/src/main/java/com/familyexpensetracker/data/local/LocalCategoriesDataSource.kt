...
class LocalCategoriesDataSource(context: Context) {
    ...
    fun getCategories(): Map<String, List<String>>? {
        val json = prefs.getString(AppConstants.KEY_CATEGORIES_MAP, null) ?: return null
        return try {
    ...
    fun saveCategories(categories: Map<String, List<String>>) {
        ...
        prefs.edit { putString(AppConstants.KEY_CATEGORIES_MAP, json) }
    }
}
